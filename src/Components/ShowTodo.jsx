...
>>>>>>> aa4244b (commit)
            ...
            <div className="flex flex-col gap-2 mr-2">
              ...
              >
                <svg
                  className='transition-transform duration-200 hover:scale-110 hover:fill-[black] rounded hover:bg-[#00CCFF]'
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="#1da1f2"
                  className="w-6 h-6 hover:fill-amber-50 hover:bg-[#00CCFF] transition-transform duration-200 hover:scale-110 rounded"
                >
